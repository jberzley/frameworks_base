...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mDesoLogo, mNetworkTraffic, mMinitBattery, mWeatherTextView, mWeatherImageView;
    ...
    public void init() {
        ...
        mDesoLogo = mView.findViewById(R.id.deso_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mDesoLogo, newAlphaBC),
